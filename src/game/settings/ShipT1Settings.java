...
public class ShipT1Settings {
	...
	public static final int 					FALCON_HEALTH = 1;				
	...
	public static final ArrayList<ARessource> 	FALCON_RESEARCHCOSTS = new ArrayList<ARessource>(Arrays.asList(
													new Iron(2000), 
													new Water(2000)));
	public static final AMath 					FALCON_COSTMOD = new Polynomial(1, 1);
