...
<br />
<table border="1">
<tr><th>Gebäude</th><th>Level</th><th>Ressource/Stunde</th><th>BauKosten</th></tr>
<tr><td>${ player.getPlanet(0).getIronMine().getName() }</td><td>${ player.getPlanet(0).getIronMine().getLevel() }</td><td>${ player.getPlanet(0).getIronMine().getResPerHour() }</td><td><c:forEach var="cost" items="${player.getPlanet(0).getIronMine().getCosts()}"><c:out value="${cost.getName()} : ${cost.getValue()}; "/></c:forEach></td></tr>
<tr><td>${ player.getPlanet(0).getRareEarthMine().getName() }</td><td>${ player.getPlanet(0).getRareEarthMine().getLevel() }</td><td>${ player.getPlanet(0).getRareEarthMine().getResPerHour() }</td><td><c:forEach var="cost" items="${player.getPlanet(0).getRareEarthMine().getCosts()}"><c:out value="${cost.getName()} : ${cost.getValue()}; "/></c:forEach></td></tr>
